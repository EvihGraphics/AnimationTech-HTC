...
from evih_reproductions.halo_4_facial_animation.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Halo 4 Facial Animation Evih/Raylib reproduction artifact.")
