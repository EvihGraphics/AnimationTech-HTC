...
CASE_SLUG = 'multiple_characters'
CONTRACT: dict[str, Any] = {'contract_name': 'multiple_characters_evih_contract', 'source_case': 'multiple_characters', 'source_contract': 'multi-instance BVH playback', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'multiple_characters', 'family': 'multi_character', 'visual_contract': 'multi-instance BVH playback'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
