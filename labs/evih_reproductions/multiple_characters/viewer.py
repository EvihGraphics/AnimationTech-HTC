...
from evih_reproductions.multiple_characters.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Multiple Characters Evih/Raylib reproduction artifact.")
