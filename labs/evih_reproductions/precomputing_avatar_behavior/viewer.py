...
from evih_reproductions.precomputing_avatar_behavior.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Precomputing Avatar Behavior Evih/Raylib reproduction artifact.")
