...
CASE_SLUG = 'precomputing_avatar_behavior'
CONTRACT: dict[str, Any] = {'contract_name': 'precomputing_avatar_behavior_evih_contract', 'source_case': 'precomputing_avatar_behavior', 'source_contract': 'precomputed graph walk', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'precomputing_avatar_behavior', 'family': 'graph', 'visual_contract': 'precomputed graph walk'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1, 'field_samples': 16}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
