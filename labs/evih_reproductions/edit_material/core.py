...
CASE_SLUG = 'edit_material'
CONTRACT: dict[str, Any] = {'contract_name': 'edit_material_evih_contract', 'source_case': 'edit_material', 'source_contract': 'material swatch states', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'edit_material', 'family': 'material', 'visual_contract': 'material swatch states'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
