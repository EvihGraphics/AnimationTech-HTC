...
from evih_reproductions.edit_material.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Edit Material Evih/Raylib reproduction artifact.")
