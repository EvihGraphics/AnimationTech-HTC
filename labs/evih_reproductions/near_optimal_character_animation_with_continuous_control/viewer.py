...
from evih_reproductions.near_optimal_character_animation_with_continuous_control.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Near Optimal Continuous Control Evih/Raylib reproduction artifact.")
