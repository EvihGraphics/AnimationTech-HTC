...
CASE_SLUG = 'near_optimal_character_animation_with_continuous_control'
CONTRACT: dict[str, Any] = {'contract_name': 'near_optimal_character_animation_with_continuous_control_evih_contract', 'source_case': 'near_optimal_character_animation_with_continuous_control', 'source_contract': 'continuous control policy path', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'near_optimal_character_animation_with_continuous_control', 'family': 'planning', 'visual_contract': 'continuous control policy path'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1, 'field_samples': 16, 'policy_waypoints': 4}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
