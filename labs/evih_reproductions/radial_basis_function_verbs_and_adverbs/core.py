...
CASE_SLUG = 'radial_basis_function_verbs_and_adverbs'
CONTRACT: dict[str, Any] = {'contract_name': 'radial_basis_function_verbs_and_adverbs_evih_contract', 'source_case': 'radial_basis_function_verbs_and_adverbs', 'source_contract': 'verb/adverb blend field', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'radial_basis_function_verbs_and_adverbs', 'family': 'field', 'visual_contract': 'verb/adverb blend field'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1, 'field_samples': 16, 'rbf_centers': 3}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
