...
CASE_SLUG = 'animation_format'
CONTRACT: dict[str, Any] = {'contract_name': 'animation_format_evih_contract', 'source_case': 'animation_format', 'source_contract': 'motion import/export schema', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'animation_format', 'family': 'bvh_motion', 'visual_contract': 'motion import/export schema'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
