...
CASE_SLUG = 'motion_warping'
CONTRACT: dict[str, Any] = {'contract_name': 'motion_warping_evih_contract', 'source_case': 'motion_warping', 'source_contract': 'root warp target', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'motion_warping', 'family': 'warping', 'visual_contract': 'root warp target'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
