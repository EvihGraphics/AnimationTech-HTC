...
CASE_SLUG = 'motion_matching'
CONTRACT: dict[str, Any] = {'contract_name': 'motion_matching_evih_contract', 'source_case': 'motion_matching', 'source_contract': 'feature query trajectory', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'motion_matching', 'family': 'matching', 'visual_contract': 'feature query trajectory'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1, 'field_samples': 16, 'query_samples': 16}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
