...
from evih_reproductions.motion_matching.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Motion Matching Evih/Raylib reproduction artifact.")
