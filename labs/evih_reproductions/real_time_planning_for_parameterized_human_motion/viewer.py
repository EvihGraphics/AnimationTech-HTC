...
from evih_reproductions.real_time_planning_for_parameterized_human_motion.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Real Time Planning For Parameterized Human Motion Evih/Raylib reproduction artifact.")
