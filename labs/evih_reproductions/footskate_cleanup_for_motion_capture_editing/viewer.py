...
from evih_reproductions.footskate_cleanup_for_motion_capture_editing.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Footskate Cleanup Evih/Raylib reproduction artifact.")
