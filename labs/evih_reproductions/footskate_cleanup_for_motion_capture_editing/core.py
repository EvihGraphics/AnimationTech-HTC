...
CASE_SLUG = 'footskate_cleanup_for_motion_capture_editing'
CONTRACT: dict[str, Any] = {'contract_name': 'footskate_cleanup_for_motion_capture_editing_evih_contract', 'source_case': 'footskate_cleanup_for_motion_capture_editing', 'source_contract': 'foot contact debug', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'footskate_cleanup_for_motion_capture_editing', 'family': 'contacts', 'visual_contract': 'foot contact debug'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1, 'contact_frames': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
