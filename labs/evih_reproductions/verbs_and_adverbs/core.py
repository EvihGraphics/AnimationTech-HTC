...
CASE_SLUG = 'verbs_and_adverbs'
CONTRACT: dict[str, Any] = {'contract_name': 'verbs_and_adverbs_evih_contract', 'source_case': 'verbs_and_adverbs', 'source_contract': 'style-conditioned motion preview', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'verbs_and_adverbs', 'family': 'style', 'visual_contract': 'style-conditioned motion preview'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
