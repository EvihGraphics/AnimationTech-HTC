...
from evih_reproductions.time_of_day.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Time Of Day Evih/Raylib reproduction artifact.")
