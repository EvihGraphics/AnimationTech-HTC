...
CASE_SLUG = 'time_of_day'
CONTRACT: dict[str, Any] = {'contract_name': 'time_of_day_evih_contract', 'source_case': 'time_of_day', 'source_contract': 'light direction samples', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'time_of_day', 'family': 'lighting', 'visual_contract': 'light direction samples'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
