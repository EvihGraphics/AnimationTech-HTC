...
from evih_reproductions.laplacian_deformation.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Laplacian Deformation Evih/Raylib reproduction artifact.")
