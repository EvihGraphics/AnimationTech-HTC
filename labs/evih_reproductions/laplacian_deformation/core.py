...
CASE_SLUG = 'laplacian_deformation'
CONTRACT: dict[str, Any] = {'contract_name': 'laplacian_deformation_evih_contract', 'source_case': 'laplacian_deformation', 'source_contract': 'deformed control chain', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'laplacian_deformation', 'family': 'deformation', 'visual_contract': 'deformed control chain'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
