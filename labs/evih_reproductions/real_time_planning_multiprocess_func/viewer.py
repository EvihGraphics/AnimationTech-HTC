...
from evih_reproductions.real_time_planning_multiprocess_func.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Real Time Planning Multiprocess Func Evih/Raylib reproduction artifact.")
