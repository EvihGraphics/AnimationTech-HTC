...
CASE_SLUG = 'real_time_planning_multiprocess_func'
CONTRACT: dict[str, Any] = {'contract_name': 'real_time_planning_multiprocess_func_evih_contract', 'source_case': 'real_time_planning_multiprocess_func', 'source_contract': 'parallel planning worker smoke', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'real_time_planning_multiprocess_func', 'family': 'planning', 'visual_contract': 'parallel planning worker smoke'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1, 'field_samples': 16, 'policy_waypoints': 4}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
