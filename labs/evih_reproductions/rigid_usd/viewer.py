...
from evih_reproductions.rigid_usd.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Rigid USD Evih/Raylib reproduction artifact.")
