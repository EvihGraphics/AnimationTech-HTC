...
CASE_SLUG = 'rigid_usd'
CONTRACT: dict[str, Any] = {'contract_name': 'rigid_usd_evih_contract', 'source_case': 'rigid_usd', 'source_contract': 'rigid transform demo', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'rigid_usd', 'family': 'rigid', 'visual_contract': 'rigid transform demo'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
