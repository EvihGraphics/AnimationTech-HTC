...
CASE_SLUG = 'radial_basis_function'
CONTRACT: dict[str, Any] = {'contract_name': 'radial_basis_function_evih_contract', 'source_case': 'radial_basis_function', 'source_contract': 'radial basis scalar field', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'radial_basis_function', 'family': 'field', 'visual_contract': 'radial basis scalar field'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1, 'field_samples': 16, 'rbf_centers': 3}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
