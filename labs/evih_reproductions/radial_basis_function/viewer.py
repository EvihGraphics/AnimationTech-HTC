...
from evih_reproductions.radial_basis_function.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Radial Basis Function Evih/Raylib reproduction artifact.")
