...
from evih_reproductions.motion_fields_for_interactive_character_animation.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Motion Fields Evih/Raylib reproduction artifact.")
