...
from evih_reproductions.motion_graph.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Motion Graph Evih Evih/Raylib reproduction artifact.")
