...
from evih_reproductions.knowing_when_to_put_your_foot_down.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Knowing When To Put Your Foot Down Evih/Raylib reproduction artifact.")
