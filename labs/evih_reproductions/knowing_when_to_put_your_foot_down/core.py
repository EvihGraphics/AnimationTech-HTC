...
CASE_SLUG = 'knowing_when_to_put_your_foot_down'
CONTRACT: dict[str, Any] = {'contract_name': 'knowing_when_to_put_your_foot_down_evih_contract', 'source_case': 'knowing_when_to_put_your_foot_down', 'source_contract': 'footfall classifier preview', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'knowing_when_to_put_your_foot_down', 'family': 'contacts', 'visual_contract': 'footfall classifier preview'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1, 'contact_frames': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
