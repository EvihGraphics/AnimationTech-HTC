...
CASE_SLUG = 'simple_sphere'
CONTRACT: dict[str, Any] = {'contract_name': 'simple_sphere_evih_contract', 'source_case': 'simple_sphere', 'source_contract': 'primitive scene smoke', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'simple_sphere', 'family': 'primitive', 'visual_contract': 'primitive scene smoke'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
