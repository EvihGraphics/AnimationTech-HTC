...
CASE_SLUG = 'animation'
CONTRACT: dict[str, Any] = {'contract_name': 'animation_evih_contract', 'source_case': 'animation', 'source_contract': 'BVH skeleton playback', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'animation', 'family': 'bvh_motion', 'visual_contract': 'BVH skeleton playback'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
