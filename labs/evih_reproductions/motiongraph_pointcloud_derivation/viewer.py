...
from evih_reproductions.motiongraph_pointcloud_derivation.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Motion Graph Point Cloud Derivation Evih/Raylib reproduction artifact.")
