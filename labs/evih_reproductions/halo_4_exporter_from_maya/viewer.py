...
from evih_reproductions.halo_4_exporter_from_maya.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Halo 4 Exporter From Maya Evih/Raylib reproduction artifact.")
