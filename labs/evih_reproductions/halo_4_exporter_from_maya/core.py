...
CASE_SLUG = 'halo_4_exporter_from_maya'
CONTRACT: dict[str, Any] = {'contract_name': 'halo_4_exporter_from_maya_evih_contract', 'source_case': 'halo_4_exporter_from_maya', 'source_contract': 'Maya fallback facial export smoke', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'halo_4_exporter_from_maya', 'family': 'halo', 'visual_contract': 'Maya fallback facial export smoke'}, 'minimums': {'frame_count': 1, 'bone_count': 16, 'curve_samples': 16, 'marker_count': 1, 'face_points': 16, 'control_points': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
