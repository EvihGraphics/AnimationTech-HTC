...
from evih_reproductions.curve_and_spline.core import load_generated, validate_metrics
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="View the Curve And Spline Evih/Raylib reproduction artifact.")
