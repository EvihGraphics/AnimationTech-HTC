...
CASE_SLUG = 'curve_and_spline'
CONTRACT: dict[str, Any] = {'contract_name': 'curve_and_spline_evih_contract', 'source_case': 'curve_and_spline', 'source_contract': 'sampled cubic and Catmull-Rom curves', 'artifact_schema': ['case', 'metrics', 'bone_names', 'parents', 'frames', 'trajectory', 'curve', 'markers', 'field_points', 'face_frames', 'face_controls', 'comparison_frames'], 'expected': {'slug': 'curve_and_spline', 'family': 'theory_curve', 'visual_contract': 'sampled cubic and Catmull-Rom curves'}, 'minimums': {'frame_count': 1, 'bone_count': 1, 'curve_samples': 16, 'marker_count': 1}, 'allowed_differences': 'Reduced deterministic Evih/Raylib reproduction; preserves concept metrics and visual evidence rather than notebook cell parity.'}
